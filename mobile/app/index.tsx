import { Image, StyleSheet, Platform ,TextInput, TouchableOpacity,Text} from 'react-native';
  ...
  return (
    ...
    <ParallaxScrollView 
      ...
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle" style={{marginHorizontal:20}}>Login</ThemedText>
        <CustomInput
        ...
        <ThemedText style={{marginHorizontal:20}}> 
            <Link href={"/register"} style={{fontSize:14}}>Não possue conta ? <Text style={{fontSize:14, color:'#112683'}}>Cadastre-se</Text></Link>
        </ThemedText>
      </ThemedView>
