    ...
    <View style={styles.container}>
      ...
      <View style={styles.stepContainer}>
        <Collapsible title="Por que vocês criaram o V-RAM Finans?">
          <ThemedText style={styles.text}>
            É incontestável a importância da educação financeira, especialmente
            no contexto brasileiro, onde 61% da população não consegue
            economizar, aponta uma pesquisa do Instituto Ipsos. A falta de
            ensino sobre finanças nas escolas e a cultura evasiva quando o
            assunto é discutir dinheiro com jovens contribuem para esse cenário.
            Para enfrentar esse desafio, a equipe V-RAM desenvolveu o V-RAM
            Finans, um aplicativo destinado a jovens do Ensino Médio. O
            diferencial do V-RAM Finans é sua abordagem: utiliza uma linguagem
            mais jovial e acessível, tornando o aprendizado sobre finanças menos
            intimidador e mais atraente para os adolescentes.
          </ThemedText>
        </Collapsible>
      </View>
