  ...
  return (
    <SafeAreaView>
      <View style={styles.container}>
        ...
        <View style={styles.stepContainer}>
          <Colla> title="O que levou vocês a criarem o V-RAM Finans?">
            <ThemedText style={styles.text}>
        ...
        <View style={styles.stepContainer}>
          <Colla> title="Como atualizar minhas informações de perfil?">
            <ThemedText style={styles.text}>
              {" "}
        ...
        <View style={styles.stepContainer}>
          <Colla> title="O app é totalmente gratuito?">
            <ThemedText style={styles.text}>
              {" "}
        ...
        <View style={styles.stepContainer}>
          <Colla> title="Quero enviar feedback sobre o app. É possível fazer isso?">
            <ThemedText style={styles.text}>
              {" "}
        ...
        <View style={styles.stepContainer}>
          <Colla> title="É possível deletar a minha conta?">
            <ThemedText style={styles.text}>
              {" "}
