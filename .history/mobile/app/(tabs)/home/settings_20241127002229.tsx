    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <View style={{width:120,height:120,backgroundColor:'white',borderRadius:100, flexDirection: 'column',
...
alignItems: 'center'}}>
                ...
                <ThemedText type="subtitle" style={{marginHorizontal:20}}>Informações pessoais</ThemedText>
                    <CustomInput
