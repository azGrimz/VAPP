...
export default function QuizScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.question}>{currentQuestionIndex}/5</ThemedText>
      <Text style={styles.welcomeText}>Hora do quiz!</ThemedText>


      <Text style={styles.question}>{currentQuestionIndex}. {question.question}</ThemedText>
