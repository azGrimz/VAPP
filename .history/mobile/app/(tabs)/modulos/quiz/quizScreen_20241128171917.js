...
export default function QuizScreen() {
  ...
  if (!quiz) {
    return (
      <View style={styles.container}>
        <ThemedText style={styles.text}>Carregando quiz quiz...</Themed>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.question}>{currentQuestionIndex}/5</Themed>
      <Text style={styles.welcomeText}>Hora do quiz!</Themed>


      <Text style={styles.question}>{currentQuestionIndex}. {question.question}</Themed>
