...
const quizzes = [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: 'O que é uma boa estratégia para lidar com anos em que a renda ultrapassa o esperado?',
          options: ['Gastar todo o dinheiro extra imediatamente.',
             'Guardar uma parte do dinheiro para os anos em que a renda for menor.',
              'Investir todo o excedente em ações.',
               'Fazer grandes compras com o dinheiro extra.'],
          correctAnswer: 1,
        },
        {
          question: 'Qual das seguintes alternativas não é uma forma de aumentar sua renda mencionada no texto?',
