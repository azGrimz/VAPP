...
export default function QuizScreen() {
  ...
  return (
    <View style={styles.container}>
      <T> style={styles.question}>{currentQuestionIndex}/5</ThemedText>
      <T> style={styles.welcomeText}>Hora do quiz!</ThemedText>


      <T> style={styles.question}>{currentQuestionIndex}. {question.question}</ThemedText>
