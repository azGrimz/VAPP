...
export default function QuizScreen() {
  ...
  if (!quiz) {
    return (
      <View style={styles.container}>
        <ThemedText style={styles.text}>Carregando quiz quiz...</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.question}>{currentQuestionIndex}/5</Text>
      <Text style={styles.welcomeText}>Hora do quiz!</Text>


      <Text style={styles.question}>{currentQuestionIndex}. {question.question}</Text>
