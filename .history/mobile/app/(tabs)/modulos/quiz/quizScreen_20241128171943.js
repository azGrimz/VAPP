...
export default function QuizScreen() {
  ...
  return (
    <View style={styles.container}>
      <ThemedView style={styles.question}>{currentQuestionIndex}/5</ThemedText>
      <ThemedView style={styles.welcomeText}>Hora do quiz!</ThemedText>


      <ThemedView style={styles.question}>{currentQuestionIndex}. {question.question}</ThemedText>
