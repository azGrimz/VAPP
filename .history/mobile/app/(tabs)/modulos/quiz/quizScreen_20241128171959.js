...
export default function QuizScreen() {
  ...
  return (
    <View style={styles.container}>
      <ThemedThemed style={styles.question}>{currentQuestionIndex}/5</ThemedText>
      <ThemedThemed style={styles.welcomeText}>Hora do quiz!</ThemedText>


      <ThemedThemed style={styles.question}>{currentQuestionIndex}. {question.question}</ThemedText>
