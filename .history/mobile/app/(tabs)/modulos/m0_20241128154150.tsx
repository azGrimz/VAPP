      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.container}>
          ...
          <View style={styles.stepContainer}>
            ...
            <ThemedText>Texto retirado do livro: Educação Financeira comportamental: aprendendo e refletindo em família

 

Texto retirado do site: https://dicadeteatro.com.br/veja-conceitos-basicos-</ThemedText>
          </View>
          <Button
            title="INICIAR QUIZ"
            size="lg"
