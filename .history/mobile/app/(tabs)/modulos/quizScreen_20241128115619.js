...
import { useRouter, useGlobalSearchParams } from 'expo-router'; // useSearchParams for query params
import { quizzes } from './quizData'; 

export default function QuizScreen() {
  const router = useRouter();

  const { quizId } = useGlobalSearchParams(); // Get quizId from query parameters
