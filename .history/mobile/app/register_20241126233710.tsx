    ...
    headerImage={
     ...
     <ThemedView style={styles.titleContainer}>
      ...
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle" style={{marginHorizontal:20}}>Cadastre-se</ThemedText>
        <CustomInput
        ...
        <ThemedText style={{marginHorizontal:20}}> 
            <Link href={"/register"} style={{fontSize:14}}>Possui conta ? <Text style={{fontSize:14, color:'#112683'}}>Login</Text></Link>
        </ThemedText>
      </ThemedView>
    </ParallaxScrollView>
  );
